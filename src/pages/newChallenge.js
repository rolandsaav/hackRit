          ...
          <div class="bg-white px-4 py-5 sm:p-6">
            <div class="grid grid-cols-6 gap-6">
              ...
              <div class="col-span-6 sm:col-span-4">
                ...
                <input type="text" name="Phone Number" id="Phone Number" autocomplete="email" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm"/>
              </div>
        ...
        <div class="overflow-hidden shadow sm:rounded-md">
          <div class="space-y-6 bg-white px-4 py-5 sm:p-6">
            <fieldset>
              ...
              <div class="text-sm font-semibold text-gray-900" aria-hidden="true">By Email</div>
              <div class="mt-4 space-y-4">
                <div class="flex items-start">
                  ...
                  <div class="ml-3 text-sm">
                    <label for="comments" class="font-medium text-gray-700">Notifications</label>
                    <p class="text-gray-500">Get notified when an update is made.</p>
                  </div>
                </div>
                <div class="flex items-start">
                  <div class="flex h-5 items-center">
                  ...
                  <div class="ml-3 text-sm">
                    <label for="candidates" class="font-medium text-gray-700">Comments</label>
                    <p class="text-gray-500">Get notified when someone posts a comment on your posting.</p>
                  </div>
                </div>
                <div class="flex items-start">
                  <div class="flex h-5 items-center">
                  ...
                  <div class="ml-3 text-sm">
                    <label for="offers" class="font-medium text-gray-700">Friends</label>
                    <p class="text-gray-500">Get notified when a friend accepts or rejects an offer.</p>
                  </div>
                </div>
              </div>
            </fieldset>
            <fieldset>
              <legend class="contents text-sm font-semibold text-gray-900">Push Notifications</legend>
